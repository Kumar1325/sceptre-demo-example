...
class SecurityGroup(CloudformationAbstractBaseClass):
    ...
    def add_parameters(self):
        ...
        self.VpcId = self.template.add_parameter(
            Parameter("VpcId", Description="VpcId", Type="AWS::EC2::VPC::Id",)
        )
    ...
    def add_resources(self):
        ...
        self.ElbSecurityGroup = self.template.add_resource(
            ec2.SecurityGroup(
                "ElbSecurityGroup",
                SecurityGroupIngress=[
                    {
        ...
        self.RDSSecurityGroup = self.template.add_resource(
            ec2.SecurityGroup(
                "RDSSecurityGroup",
                SecurityGroupIngress=[
                    {
    ...
    def add_outputs(self):
        ...
        self.template.add_output(
            [
                ...
                Output("AppSG", Value=Ref(self.WebSecurityGroup)),
